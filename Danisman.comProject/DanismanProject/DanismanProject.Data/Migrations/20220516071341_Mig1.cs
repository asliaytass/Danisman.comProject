        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentImg = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubcategoryAdvisors", x => new { x.AdvisorId, x.SubcategoryId });
                    table.ForeignKey(
                        name: "FK_SubcategoryAdvisors_Advisors_AdvisorId",
                        column: x => x.AdvisorId,
                        principalTable: "Advisors",
                        principalColumn: "AdvisorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubcategoryAdvisors_Subcategories_SubcategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubcategoryAdvisors_SubcategoryId",
                table: "SubcategoryAdvisors",
